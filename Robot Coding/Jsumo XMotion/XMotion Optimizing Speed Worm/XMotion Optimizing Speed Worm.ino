...
void starting3() {
  xmotion.Right0(100, 350);   // Speed, Duration (Right Motor Backward, Left Forward)
  xmotion.Forward(100, 300);  // Speed, Duration
}
...
void stalking() {
  if (distanceR < 15 || distanceL < 15) {
    ...
    xmotion.MotorControl(255, 255);
  } else if (distanceR < 38 && distanceL < 38) {  //if both sensors less than than 25 cm, go forward
    xmotion.MotorControl(255, 255);
    Serial.println("Both Motor Forward");
  } else if (distanceR > 38 && distanceL < 38) {  //if only something is in front of the left ultrasonic sensor, turn left
    xmotion.MotorControl(230, -230);
    Serial.println("Turn Left");
  } else if (distanceR < 38 && distanceL > 38) {  //if only something is in front of the right ultrasonic sensor, turn right
    xmotion.MotorControl(-230, 230);
