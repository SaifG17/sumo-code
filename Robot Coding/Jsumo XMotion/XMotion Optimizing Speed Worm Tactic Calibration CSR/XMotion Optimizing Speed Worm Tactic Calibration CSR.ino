...
void starting1() {
  xmotion.Left0(100, 220);        // Speed, Duration (Right Motor Forward, Left Backward)
  xmotion.ArcTurn(30, 100, 900);  // Left speed, Right speed, Duration in percent
...
void starting2() {
  xmotion.Right0(100, 220);       // Speed, Duration (Right Motor Backward, Left Forward)
...
void starting3() {
  xmotion.Right0(100, 500);   // Speed, Duration (Right Motor Backward, Left Forward)
  xmotion.Forward(100, 400);  // Speed, Duration
}

void starting4() {
  xmotion.Left0(100, 420);  // Speed, Duration (Right Motor Backward, Left Forwar
}

void standby() {  // Standby search opponentv
  xmotion.MotorControl(165, -165);
}
...
void lineroaming() {
  ...
  xmotion.MotorControl(255, 255);  // Adjust delay untuk adjust degree turning
}
